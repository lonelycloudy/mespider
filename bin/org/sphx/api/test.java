...
//			System.out.print ( "-d, --distinct <ATTR>\tcount distinct values of 'ATTR''\n" );
		...
		String host = "192.168.0.193";//localhost
		int port = 9312;
...
/*
[root@2 src]# javac -d . org/sphx/api/test.java 
注意：./org/sphx/api/SphinxClient.java 使用了未经检查或不安全的操作。
注意：要了解详细信息，请使用 -Xlint:unchecked 重新编译。
You have new mail in /var/spool/mail/root
[root@2 src]# java -cp ./ org.sphx.api.test doc
Query 'doc ' retrieved 2 of 2 matches in 0.018 sec.
Query stats:
        'doc' found 2 times in 2 documents

Matches:
1. id=3, weight=100, group_id=2, date_added=Mon May 28 08:16:50 CST 2012
2. id=4, weight=100, group_id=2, date_added=Mon May 28 08:16:50 CST 2012
 */
